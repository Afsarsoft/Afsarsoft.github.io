class ProjectInput {
  ...
  sectionCenter: HTMLElement;
  btnContainer: HTMLElement;

  constructor() {
    this.sectionCenter = document.querySelector(".section-center")! as HTMLElement;
    this.btnContainer = document.querySelector(".btn-container")! as HTMLElement;
  }
...
// Let's define type to get intellisense
type Menu = {
  id: number,
  title: string,
  category: string,
...
function displayMenuItems(menuItems: Menu) {
  ...
  let strDisplayMenu: string = displayMenu.join("");
...
function displayMenuButtons() {
  const categories = prj.menu.reduce(
  ...
  filterBtns.forEach((btn) => {
    btn.addEventListener("click", (e) => {
      ...
      const category = (<HTMLInputElement>e.currentTarget).dataset.id;
